...
public class ImageListAdapter extends RecyclerView.Adapter<ImageListAdapter.InnerHolder> {
    ...
    public static List<PhotoItem> files = new ArrayList<>();
    ...
    @Override
    public void onBindViewHolder(@NonNull InnerHolder innerHolder, @SuppressLint("RecyclerView") final int i) {
